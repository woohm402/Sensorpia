...
이 이용약관(이하 '약관')은 주식회사 (주)센서피아(이하 회사라 합니다)와 이용 고객(이하 '회원')간에 회사가 제공하는 서비스의 가입조건 및 이용에 관한 제반 사항과 기타 필요한 사항을 구체적으로 규정함을 목적으로 합니다.

제2조(이용약관의 효력 및 변경)
① 이 약관은 본 회사에 가입된 고객을 포함하여 서비스를 이용하고자 하는 모든 이용자에 대하여 서비스 메뉴 및 회사에 게시하여 공시하거나 기타의 방법으로 고객에게 공지함으로써 그 효력을 발생합니다. 약관의 게시는 (주)센서피아 사이트에서 확인 할 수 있습니다.
...
회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 (주)센서피아 웹 내의 "회원탈퇴"메뉴를 이용해 가입해지를 해야 합니다.
